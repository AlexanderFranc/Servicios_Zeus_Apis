...
namespace Core.Dtos.Core
{
    public class EmpleadoDto
    {
        ...
        public string? TiempoResidenciaEc { get; set; }

        public string? CorreoInst { get; set; }

        public string? TipoSangre { get; set; }

        public bool? CarnetConadis { get; set; }

        public int? IdTipoDiscapacidad { get; set; }

        public string? NumeroCarnetConadis { get; set; }

        public decimal? PorcentajeDisc { get; set; }

        public int? IdEtnia { get; set; }

        public string? CedulaArchivo { get; set; }
        ...
        //public virtual ICollection<ExperienciaDocente> ExperienciaDocentes { get; } = new List<ExperienciaDocente>();

        //public virtual ICollection<ExperienciaLaboral> ExperienciaLaborals { get; } = new List<ExperienciaLaboral>();
