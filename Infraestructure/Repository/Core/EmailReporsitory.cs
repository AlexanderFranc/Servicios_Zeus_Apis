...
namespace Infraestructure.Repository.Core
{
    public class EmailReporsitory : IEmailReporsitory
    {
        ...
        //CORREO CUANDO SE REALIZA EL INGRESO DE UN NUEVO DOCENTE
        ...
        // CORREO CUANDO INGRESA UNA NUEVA SOLICITUD DE PLANIFICACIÓN
        public async Task CorreoCambioPlanificacion(EmailSolicitudPlanificacionDto emaildata)
        {
            ...
            string bodyTmp = "<!DOCTYPE html>\r\n<html lang=\"en\">\r\n\r\n" +
                ...
                "           <td>\r\n" +
                "               <p style=\"margin:0 0 12px 0;font-size:16px;line-height:24px;font-family:Arial,sans-serif;\">\r\n" +
                "                       Se le informa que se ha ingresado una nueva solicitud de cambio/creación de planificación con los siguientes datos:\r\n" +
                "               </p>\r\n" +
                "           </td>\r\n" +
                "       </tr>\r\n" +
                "       <tr>\r\n" +
                "           <td>\r\n" +
                "               <ul>\r\n" +
                "                   <li>PERIODO: " + emaildata.periodo + "</li>\r\n" +
                "                   <li>FACULTAD: " + emaildata.facultad + "</li>\r\n" +
                "                   <li>CARRERA: " + emaildata.carrera + "</li>\r\n" +
                "                   <li>PLAN DE ESTUDIO: " + emaildata.planEstudio + "</li>\r\n" +
                "                   <li>MODALIDAD: " + emaildata.modalidad + "</li>\r\n" +
                "                   <li>MATERIA: " + emaildata.materia + "</li>\r\n" +
                "                   <li>SUBTIPO COMPONENTE: " + emaildata.subtipoComponente + "</li>\r\n" +
                "                   <li>PARALELO: " + emaildata.paralelo + "</li>\r\n" +
                "               </ul>\r\n" +
                "           </td>\r\n" +
                "       </tr>\r\n" +
                "       <tr>\r\n" +
